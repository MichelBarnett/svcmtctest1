...
This repo was created to store, manage changes to, and host troubleshooting guides for the Marine Maintenance Technology Program.  There are a few key goals this repo aims to achieve:

- **Format** - Use a format for the troubleshooting guides that's simple, widely used, and easily accessible.
- **Storage** - Leverage a reliable service for storing the troubleshooting guides
- **Change Management** - Leverage a service that provides a structured version control system for the stored content.  This includes  features for tracking contributions, providing audit trails, tracking version history, and supporting secure approval.
- **Publication** - A simple way to publish the content to the intended audience.

To achieve these goals the following technologies were chosen:
...
The following details how this site was created to achieve the goals listed above.
